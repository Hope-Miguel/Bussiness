...
function useControlled(_ref) {
  ...
  var _React$useRef = React3.useRef(controlled !== void 0), isControlled = _React$useRef.current;
  var _React$useState = React3.useState(defaultProp), valueState = _React$useState[0], setValue = _React$useState[1];
  ...
  if (true) {
    ...
    var _React$useRef2 = React3.useRef(defaultProp), defaultValue = _React$useRef2.current;
    React3.useEffect(function() {
  ...
  var setValueIfUncontrolled = React3.useCallback(function(newValue) {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
//# sourceMappingURL=chunk-2DUG74JJ.js.map
